    ...
    <label className="flex flex-col gap-1">
      ...
      <div className="flex">
        ...
        <input
          ...
          {...props}
        />
        <label className="flex justify-center items-center cursor-pointer rounded-e text-gray-300 dark:text-gray-600 bg-gray-600 dark:bg-gray-300 hover:bg-gray-700 dark:hover:bg-gray-200 transition-colors">
